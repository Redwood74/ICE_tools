    ...
    def to_dict(self) -> dict:
        return {
            ...
            "facility_legal_and_case_information": (
                self.best_result.facility_legal_and_case_information if self.best_result else None
            ),
            ...
            "facility_sending_items_to_detainees": (
                self.best_result.facility_sending_items_to_detainees if self.best_result else None
            ),
            ...
            "facility_feedback_or_complaints": (
                self.best_result.facility_feedback_or_complaints if self.best_result else None
            ),
        }
